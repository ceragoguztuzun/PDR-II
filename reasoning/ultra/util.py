...
def parse_args():
    ...
    parser.add_argument("-pid", '--patient_id', help='patient id', type=int)
    parser.add_argument('--use_ploss', action='store_true', help='flag for indicating we want to fine-tune using patient specific loss')
    parser.add_argument("-l1", '--lambda1_prs', help='lambda1 value to set influence of PRS values in patient specific loss', type=float)
    parser.add_argument("-l2", '--lambda2_biomarker', help='lambda2 value to set influence of biomarker expression values in patient specific loss', type=float)


    parser.add_argument('--this_is_a_case_study', action='store_true', help='flag for indicating case study')
